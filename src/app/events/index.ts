/*Creating a parent barrel to optimize and handle better our imports and exports by adding them all together */
...
export * from './event-details/up-vote/up-vote.component'
